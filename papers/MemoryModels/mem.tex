...
possible to change out the set of labels for a new set.  Conceptually,
...
but different labels should in some sense be ``interchangeable''
(though of course they are not identical).

\todo{discuss bijection vs not.}

\ExecuteMetaData[latex/models.tex]{memrecord-relabel}
